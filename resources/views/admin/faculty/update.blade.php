<div class="modal fade" id="faculty-update" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
     aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form class="form-horizontal" id="frm-update" method="POST" action="{{url('/admin/faculty/update')}}">
                    {{ csrf_field() }}
