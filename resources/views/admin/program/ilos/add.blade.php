<div class="modal fade" id="add_program_ilos" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
     aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="ins_program_ilos" class="form-horizontal" method="POST" action="{{route('addProgramIlos') }}">
                    {{ csrf_field() }}
