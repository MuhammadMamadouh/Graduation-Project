<div class="modal fade" id="add_facility" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
     aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="ins_facility" class="form-horizontal" method="POST" action="{{route('facilityAdd') }}">
                    {{ csrf_field() }}
